...
import { displayDays, displayHours, displayMinutes, displaySeconds } from '../utils/display'
  ...
  return (
    <div className={`border border-${themeColor}-500 rounded-xl p-3 flex flex-row justify-between`}>
      <div className="flex flex-col gap-2">
        ...
        <div className="lg:text-lg text-md">Price 0.029 ETH</div>
            ...
            <>
              {
                itemStatus === ItemStatus.Before ?
                  ...
                  :
                  <div className='text-cyan-500'>Started before</div>
              }
            </>
        }
        {
